...
<%--&lt;%&ndash;<div>&ndash;%&gt;--%>
  <%--&lt;%&ndash;<table data-toggle="table" data-striped="true">&ndash;%&gt;--%>
    <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td align="center">课程名称</td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td align="center">负责教练</td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td align="center">顾客</td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td align="center">课程时间安排</td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td align="center">课程状态</td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td></td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;<td></td>&ndash;%&gt;--%>
    <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<c:forEach items="${schemas}" var="item" varStatus="status">&ndash;%&gt;--%>
      <%--&lt;%&ndash;<tr>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="50px" align="center" hidden><c:out value="${item.schemaId}"/></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="50px" align="center"><c:out value="${item.course.name}"/></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="30px" align="center"><c:out value="${item.employee.employeeName}"/></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="30px" align="center"><c:out value="${item.customer.name}"/></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="30px" align="center"><c:out value="${item.date}"/></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="30px" align="center"><c:out value="${item.state}"/></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="50px" align="center"><a type="button" href="/web/schemaOperate/deleteSchema?schemasId=<c:out value="${item.schemaId}"/>">delete</a></td>&ndash;%&gt;--%>
        <%--&lt;%&ndash;<td width="50px" align="center"><a type="button" href="/web/schemaOperate/goToSchemaUpdate?schemasId=<c:out value="${item.schemaId}"/>">update</a></td>&ndash;%&gt;--%>
      <%--&lt;%&ndash;</tr>&ndash;%&gt;--%>
